                    ...
                    <div className="p-4">
                            ...
                            <div className="row">
                                ...
                                <div className="my-details">
                                        ...
                                        <p>Hello, I'm Alamgir Hossain, I can help you with HTML, CSS, Bootstrap, JavaScript, React, Node.js, MongoDB, and Express. I'm not a master of any, but know how to use Google for help.</p>
                                ...
                                <div className="col-md-4 offset-md-1">
                                    ...
                                    <div className="my-info">
                                        ...
                                        <p className='my-1'>
                                            <span className='h6 m-0'>Phone</span> : +8801963697077
                                        </p>
