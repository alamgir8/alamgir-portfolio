      ...
      <div className="resume">
        <div className="p-4">
          <div className="px-3 py-5">
            <h1 className="offset-md-2 my-resume pb-2 text-primary">
              MY RESUME{' '}
              <span className="icon">
                ...
                <div className="education-section p-3">
                  ...
                  <div className="ssc pb-3">
                    ...
                    <div className="py-0">
                      ...
                      <p className="my-0">
                        <small>Gaibandha NH Modern High School</small>
                      </p>
                      <p className="my-0">
                        Complete SSC from Commerce Group at 4.81 GPA
                      </p>
                    </div>
                  </div>
                  <div className="hsc pb-3">
                    ...
                    <div className="py-0">
                      ...
                      <p className="my-0">
                        <small>Gaibandha Govt Collage</small>
                      </p>
                      <p className="my-0">
                        Complete HSC from Commerce Group at 4.90 GPA
                      </p>
                    </div>
                  </div>
                  <div className="honours pb-3">
                    ...
                    <div className="py-0">
                      ...
                      <p className="my-0">
                        <small>Kazi Azimuddin Collage</small>
                      </p>
                  ...
                  <div className="masters pb-3">
                    ...
                    <div className="py-0">
                      ...
                      <p className="my-0">
                        <small>Tongi Govt Collage</small>
                      </p>
                ...
                <div className="experience-section p-3">
                  ...
                  <div className="idb-training pb-1">
                    ...
                    <div className="my-0">
                      ...
                      <p>
                        Complete HTML,CSS and Javascript from IDB scholarship
                        project round 41
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="programing-hero pb-1">
                    ...
                    <div className="py-0">
                      <p className="py-0 h6">
                        Bootstrap, Javascript, React, Node, MongoDB
                      </p>
                      <p>
                        Complete Bootstrap, Javascript, React, Node and MongoDB
                        from Complete Web Development Course with{' '}
                        <span className="h6">Jhankar Mahbub</span>{' '}
                      </p>
                    </div>
                  </div>
                </div>
